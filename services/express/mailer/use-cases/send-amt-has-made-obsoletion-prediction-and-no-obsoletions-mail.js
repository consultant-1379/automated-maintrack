function makeSendAmtHasMadeObsoletionPredictionAndNoObsoletionsRequiredMail(sendEmail) {
  return async function sendAmtHasMadeObsoletionPredictionAndNoObsoletionsRequiredMail(slot, predictions, obsoletionStatus, bugsAndTRsOnlyStatus) {
    const emailSubject = `${slot.productSetVersion} - AMT has predicted that no DG obsoletions are required`;
...
module.exports = { makeSendAmtHasMadeObsoletionPredictionAndNoObsoletionsRequiredMail };
