function makeUpgradeFailureAndSendAllDeliveryGroupsObsoletedSuccessMail(sendEmail) {
  return async function sendUpgradeFailureAndAllDeliveryGroupsObsoletedSuccessMail(obsoletedDeliveryGroups, slot, predictions,
    obsoletionStatus, bugsAndTRsOnlyStatus, slotUgFailureBehaviour) {
    const emailSubject = `${slot.productSetVersion} - UG Job(s) Failed, AMT has obsoleted all DGs`;
...
module.exports = { makeUpgradeFailureAndSendAllDeliveryGroupsObsoletedSuccessMail };
