function makeSendAmtFailedToMakePredictionsAndShutdownAmtMail(sendEmail) {
  return async function sendAmtFailedToMakePredictionsAndShutdownAmtMail(slot) {
    const emailSubject = `${slot.productSetVersion} - AMT failed to make DG obsoletion predictions, 
    AMT trigger & DG obsoletion switches both turned OFF`;
...
module.exports = { makeSendAmtFailedToMakePredictionsAndShutdownAmtMail };
