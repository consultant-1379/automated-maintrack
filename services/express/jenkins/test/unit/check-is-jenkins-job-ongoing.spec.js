...
describe('Unit Test: Get Jenkins Build Status Use Case', () => {
  ...
  before(() => {
    ...
    checkIsJenkinsJobOngoing = makeCheckIsJenkinsJobOngoing(fakeGetJenkinsJob, functionalUserIsAvailableOrTesting);
  });
