...
const { filterAllDeliveryGroupsFromExclusionTeamList } = require('../../use-cases');

const LIST_OF_EXCLUDED_TEAM_NAME = [
  {
    id: 'ckt31741800010ill72pn75e1',
    teamName: 'BladeRunners',
    jiraUrls: '[No - Jira]',
    signum: 'zbxxsub',
    createdOn: 'Thu, 02 Sep 2021 14:36:19 GMT',
    modifiedOn: 'Thu, 02 Sep 2021 14:36:19 GMT',
  },
  {
    id: 'ckt3yfrmw00020illghb785fq',
    teamName: 'Ameya',
    jiraUrls: '[No - Jira]',
    signum: 'zbxxsub',
    createdOn: 'Fri, 03 Sep 2021 06:06:50 GMT',
    modifiedOn: 'Fri, 03 Sep 2021 06:06:50 GMT',
  },
  {
    id: 'ckt46171w000e0illf8evfqil',
    teamName: 'Apollo',
    jiraUrls: [],
    signum: 'zbxxsub',
    createdOn: 'Fri, 03 Sep 2021 09:39:27 GMT',
    modifiedOn: 'Fri, 03 Sep 2021 09:39:27 GMT',
  },
];

const EMPTY_LIST_OF_EXCLUDED_TEAM_NAME = [];
...
describe('Unit Test: Filter Excluded Team Names use-case.', () => {
  it('should filter out DGs that are present in excluded team list.', () => {
    const filteredDeliveryGroups = filterAllDeliveryGroupsFromExclusionTeamList(ALL_DELIVERY_GROUPS_21_04, LIST_OF_EXCLUDED_TEAM_NAME);
    expect(filteredDeliveryGroups).toEqual(CORRECTLY_FILTERED_DELIVERY_GROUPS);
  });
  it('should not filter out any DGs if there no Team names matching in the delivery queue team exclusion list', () => {
    const filteredDeliveryGroups = filterAllDeliveryGroupsFromExclusionTeamList(ALL_DELIVERY_GROUPS_21_07, LIST_OF_EXCLUDED_TEAM_NAME);
    expect(filteredDeliveryGroups).toEqual(ALL_DELIVERY_GROUPS_21_07);
  });
  it('should not filter out any DGs if the delivery queue team exclusion list is empty', () => {
    const filteredDeliveryGroups = filterAllDeliveryGroupsFromExclusionTeamList(ALL_DELIVERY_GROUPS_21_04, EMPTY_LIST_OF_EXCLUDED_TEAM_NAME);
    expect(filteredDeliveryGroups).toEqual(ALL_DELIVERY_GROUPS_21_04);
  });
});
