...
const { filterDuplicateRpms } = require('../../use-cases');
...
describe('Unit Test: Filter Duplicate rpms use-case.', () => {
  it('should filter out DGs that have the newer version of the duplicate rpms.', () => {
    const filteredDeliveryGroups = filterDuplicateRpms(ALL_DELIVERY_GROUPS_21_04);
    expect(filteredDeliveryGroups).toEqual(CORRECTLY_FILTERED_DELIVERY_GROUPS);
  });
  it('should not filter out any DGs if there are no duplicate rpms', () => {
    const filteredDeliveryGroups = filterDuplicateRpms(ALL_DELIVERY_GROUPS_21_07);
