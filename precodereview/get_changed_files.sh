...
function get_changed_files() {
    ...
    echo "COMMAND: ${GIT_CMD} pull ${GERRIT_MIRROR}/OSS/com.ericsson.oss.ci.rtd/automated-maintrack ${GERRIT_REFSPEC}"
    ${GIT_CMD} pull "${GERRIT_MIRROR}"/OSS/com.ericsson.oss.ci.rtd/automated-maintrack "${GERRIT_REFSPEC}"
